...
//#endregion
export { AllLayoutProperties, AllPaintProperties, Color, ColorArray, ColorType, type CompositeExpression, CompoundExpression, EvaluationContext, type Feature, type FeatureState, FormatExpression, Formatted, type FormattedSection, FormattedType, type GlobalProperties, type ICanonicalTileID, type ILngLat, type ILngLatLike, type IMercatorCoordinate, Interpolate, type InterpolationType, Literal, NullType, NumberArray, Padding, ParsingError, ProjectionDefinition, ProjectionDefinitionType, ResolvedImage, type SourceExpression, Step, StyleExpression, type StylePropertyExpression, StylePropertyFunction, StylePropertySpecification, type Type, ValidationError, VariableAnchorOffsetCollection, ZoomConstantExpression, ZoomDependentExpression, classifyRings, convertFilter, convertFunction, createExpression, createFunction, createPropertyExpression, createVisibility as createVisibilityExpression, derefLayers, diff, emptyStyle, expression, expressions, featureFilter, format, styleFunction as function, groupByLayout, interpolateFactory as interpolates, isExpression, isFunction, isZoomExpression, _default as latest, migrate, normalizePropertyExpression, supportsPropertyExpression, typeToString as toString, typeOf, v8, validate, validateStyleMin, visit };