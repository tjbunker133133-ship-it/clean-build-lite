...
//#endregion
//#region node_modules/rw/lib/rw/decode.js
...
//#endregion
//#region node_modules/rw/lib/rw/read-file.js
var require_read_file = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var fs$3 = __require("fs"), decode$1 = require_decode();
	module.exports = function(path, options, callback) {
		...
		fs$3.stat(path, function(error, stat) {
			...
			readStream(fs$3.createReadStream(path, options ? { flags: options.flag || "r" } : {}), options, callback);
		});
	};
...
//#endregion
//#region node_modules/rw/lib/rw/read-file-sync.js
var require_read_file_sync = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var fs$2 = __require("fs"), decode = require_decode();
	module.exports = function(filename, options) {
		if (fs$2.statSync(filename).isFile()) return fs$2.readFileSync(filename, options);
		else {
			var fd = fs$2.openSync(filename, options && options.flag || "r"), decoder = decode(options);
			while (true) {
				try {
					var buffer = new Buffer(bufferSize), bytesRead = fs$2.readSync(fd, buffer, 0, bufferSize);
				} catch (e) {
					if (e.code === "EOF") break;
					fs$2.closeSync(fd);
					throw e;
...
//#endregion
//#region node_modules/rw/lib/rw/encode.js
...
//#endregion
//#region node_modules/rw/lib/rw/write-file.js
var require_write_file = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var fs$1 = __require("fs"), encode$1 = require_encode();
	module.exports = function(path, data, options, callback) {
		...
		fs$1.stat(path, function(error, stat) {
			...
			writeStream(fs$1.createWriteStream(path, options ? { flags: options.flag || "w" } : {}), "end", data, options, callback);
		});
	};
	function writeStream(stream, send, data, options, callback) {
		...
		stream[send](encode$1(data, options), function(error) {
			callback(error && error.code === "EPIPE" ? null : error);
		});
	}
}));
//#endregion
//#region node_modules/rw/lib/rw/write-file-sync.js
var require_write_file_sync = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var fs = __require("fs"), encode = require_encode();
	module.exports = function(filename, data, options) {
		...
		if (!stat || stat.isFile()) fs.writeFileSync(filename, data, options);
		else {
			var fd = fs.openSync(filename, options && options.flag || "w"), bytesWritten = 0, bytesTotal = (data = encode(data, options)).length;
			while (bytesWritten < bytesTotal) try {
...
//#endregion
//#region node_modules/rw/lib/rw/dash.js
var require_dash = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.readFile = dashify(require_read_file(), "/dev/stdin");
	exports.readFileSync = dashify(require_read_file_sync(), "/dev/stdin");
	exports.writeFile = dashify(require_write_file(), "/dev/stdout");
	exports.writeFileSync = dashify(require_write_file_sync(), "/dev/stdout");
}));
//#endregion
//#region node_modules/rw/index.js
var require_rw = /* @__PURE__ */ __commonJSMin(((exports) => {
	exports.dash = require_dash();
	exports.readFile = require_read_file();
	exports.readFileSync = require_read_file_sync();
	exports.writeFile = require_write_file();
	exports.writeFileSync = require_write_file_sync();
}));
//#endregion
//#region src/error/validation_error.ts
var import_minimist = /* @__PURE__ */ __toESM(require_minimist(), 1);
var import_rw = /* @__PURE__ */ __toESM(require_rw(), 1);
...
if (argv.help || argv.h || !argv._.length && process.stdin.isTTY) help();
	...
	argv._.forEach((file) => {
		const errors = validateStyle(import_rw.readFileSync(file, "utf8"));
		if (errors.length) {
