...
//#endregion
export { AllLayoutProperties, AllPaintProperties, BackgroundLayerSpecification, CameraFunctionSpecification, CircleLayerSpecification, CollatorExpressionSpecification, Color, ColorArray, ColorArraySpecification, ColorReliefLayerSpecification, ColorSpecification, ColorType, type CompositeExpression, CompositeFunctionSpecification, CompoundExpression, DataDrivenPropertyValueSpecification, EvaluationContext, ExpressionFilterSpecification, ExpressionInputType, ExpressionSpecification, type Feature, type FeatureState, FillExtrusionLayerSpecification, FillLayerSpecification, FilterSpecification, FontFacesSpecification, FormatExpression, Formatted, type FormattedSection, FormattedSpecification, FormattedType, GeoJSONSourceSpecification, type GlobalProperties, HeatmapLayerSpecification, HillshadeLayerSpecification, type ICanonicalTileID, type ILngLat, type ILngLatLike, type IMercatorCoordinate, ImageSourceSpecification, Interpolate, InterpolationSpecification, type InterpolationType, LayerSpecification, LegacyFilterSpecification, LightSpecification, LineLayerSpecification, Literal, MLFontFace, NullType, NumberArray, NumberArraySpecification, Padding, PaddingSpecification, ParsingError, ProjectionDefinition, ProjectionDefinitionSpecification, ProjectionDefinitionT, ProjectionDefinitionType, ProjectionSpecification, PromoteIdSpecification, PropertyValueSpecification, RasterDEMSourceSpecification, RasterLayerSpecification, RasterSourceSpecification, ResolvedImage, ResolvedImageSpecification, SchemaSpecification, SkySpecification, type SourceExpression, SourceFunctionSpecification, SourceSpecification, SpriteSpecification, StateSpecification, Step, StyleExpression, type StylePropertyExpression, StylePropertyFunction, StylePropertySpecification, StyleSpecification, SymbolLayerSpecification, TerrainSpecification, TransitionSpecification, type Type, ValidationError, VariableAnchorOffsetCollection, VariableAnchorOffsetCollectionSpecification, VariableExpressionSpecification, VectorSourceSpecification, VideoSourceSpecification, VisibilitySpecification, ZoomConstantExpression, ZoomDependentExpression, classifyRings, convertFilter, convertFunction, createExpression, createFunction, createPropertyExpression, createVisibility as createVisibilityExpression, derefLayers, diff, emptyStyle, expression, expressions, featureFilter, format, styleFunction as function, groupByLayout, interpolateFactory as interpolates, isExpression, isFunction, isZoomExpression, _default as latest, migrate, normalizePropertyExpression, supportsPropertyExpression, typeToString as toString, typeOf, v8, validate, validateStyleMin, visit };