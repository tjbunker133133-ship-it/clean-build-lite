...
/**
 * Classic layer compass — full cockpit dial with explicit numeric heading.
 * Dense, utilitarian, always-visible navigation readout.
 */
export default function ClassicCompass({
  heading,
  status,
  cardinal,
  size = 56,
  ...
  const degreeLabel =
    active && heading != null ? `${Math.round(heading)}°` : status === 'level' ? '—' : '•'
